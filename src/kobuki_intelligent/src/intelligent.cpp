...
Intelligent::Intelligent() {
    ...
    sub_cliff_ = node_handle_.subscribe("/mobile_base/events/cliff", 1, &Intelligent::CliffCallback, this);
    ...
    pub_arm_ = node_handle_.advertise<std_msgs::Int16MultiArray>("/joint_array",1);
